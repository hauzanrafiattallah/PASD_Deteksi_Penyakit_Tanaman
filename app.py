...
if page == "Welcome":
    st.title("Green Cure 🔍🌱")
    st.header("👋 Selamat Datang di Aplikasi Pendeteksi Penyakit Tanaman!")
    ...
    st.markdown("---")
    st.write("🔗 [GitHub](https://github.com/hauzanrafiattallah/PASD_Deteksi_Penyakit_Tanaman)")